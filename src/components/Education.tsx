        ...
        <div className="rounded-2xl overflow-hidden border border-stone-100 mx-auto w-fit">
          ...
          <div className="px-6 py-5 flex items-start justify-between gap-6">
            <div>
              ...
              <p className="text-sm text-stone-400">Management & IT · Bachelor of Business Administration</p>
              <p className="text-sm text-stone-600 leading-relaxed mt-3 max-w-sm">
                Studied at the intersection of business and technology — software development,
                data analytics, systems design, and management strategy.
              </p>
            </div>
